...
public class Bunker : MonoBehaviour
{
    ...
    {
        // Cada bunker necesita una instancia unica de la textura del sprite puesto que este se modifica desde el original
    ...
    private bool Splat(Vector3 hitPoint)
    {
        ...
        // Solo lo realiza si el punto en el que choca es un pixel ocupado
        ...
        // Modifica el punto a la mitad del tamaño para que la "mancha" esté
        // centrada al rededor del punto golpeado
        px -= splat.width / 2;
        py -= splat.height / 2;
